# kr1_dict_from_string_task_3_4_1.py
# Завдання 3.4.1. Функція, яка приймає рядок тексту і повертає словник, 
...
print("\n** Завдання 3.4.1. Напишіть функцію, яка приймає рядок тексту і повертає словник,")
print("де ключами є слова з тексту, а значеннями  -  їхня частота появи **")
